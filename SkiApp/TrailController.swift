...
class TrailController {
    ...
    static var trailArray: [Trails] {
        ...
        let centerOfGravity = Trails(trailName: "Center of Gravity", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let fieldsOfGlory = Trails(trailName: "Fields of Glory", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let highBaldyTraverse = Trails(trailName: "High Baldy Traverse", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let highRidge3 = Trails(trailName: "High Ridge 3", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let midBaldyTraverse = Trails(trailName: "Mid - Baldy Traverse", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let thanksForTheMemories = Trails(trailName: "Thanks for the Memories", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let venusLine = Trails(trailName: "Venus Line", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let westBaldy = Trails(trailName: "West Baldy", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let blackjackGully = Trails(trailName: "Blackjack Gully", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let blackjackTraverse = Trails(trailName: "Blackjack Traverse", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let condoBypass = Trails(trailName: "Condo Bypass", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let gunTowers = Trails(trailName: "Gun Towers", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let lightningTreeGully = Trails(trailName: "Lightning Tree Gully", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let shot8 = Trails(trailName: "Shot 8", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let theKeyhole = Trails(trailName: "The Keyhole", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let westwardHo = Trails(trailName: "Westward Ho", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let whoCares = Trails(trailName: "Who Cares", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let whodunnit = Trails(trailName: "Whodunnit", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let chipsAccess = Trails(trailName: "Chip's Access", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let chipsBypass = Trails(trailName: "Chip's Bypass", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let chipsFace = Trails(trailName: "Chip's Face", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let chipsRun = Trails(trailName: "Chip's Run", trailLift: "Peruvian", trailDifficulty: "3", trailStatus: "", trailGroomed: "")
        let hubbaBubba = Trails(trailName: "Hubba Bubba", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let lowerChipsRun = Trails(trailName: "Lower Chip's Run", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let middleChipsRun = Trails(trailName: "Middle Chip's Run", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let phone3Shot = Trails(trailName: "Phone 3 Shot", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let rothmanWay = Trails(trailName: "Rothman Way", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let upperPrimrosePath = Trails(trailName: "Upper Primrose Path", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let willows = Trails(trailName: "Willows", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let adager = Trails(trailName: "Adager", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let andersonsHill = Trails(trailName: "Anderson's Hill", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let cliffAccess = Trails(trailName: "Cliff Access", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let hotFootGully = Trails(trailName: "Hot Foot Gully", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let hotLipsGully = Trails(trailName: "Hot Lips Gully", trailLift: "Peruvian", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let lowerPrimrosePath = Trails(trailName: "Lower Primrose Path", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let lowerSilverFox = Trails(trailName: "Lower Silver Fox", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let ohMyGod = Trails(trailName: "Oh My God", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let route4Gully = Trails(trailName: "Route 4 Gully", trailLift: "Peruvian", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let upperSilverFox = Trails(trailName: "Upper Silver Fox", trailLift: "Peruvian", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        ...
        let birdsNest = Trails(trailName: "Bird's Nest", trailLift: "Baldy", trailDifficulty: "1", trailStatus: "", trailGroomed: "")
        let claimJumper = Trails(trailName: "Claim Jumper", trailLift: "Baldy", trailDifficulty: "1", trailStatus: "", trailGroomed: "")
        let luckeyBoy = Trails(trailName: "Luckey Boy", trailLift: "Baldy", trailDifficulty: "1", trailStatus: "", trailGroomed: "")
        let skiPatrolGully = Trails(trailName: "Ski Patrol Gully", trailLift: "Baldy", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let forty9erGully = Trails(trailName: "49er Gully", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let bassanova = Trails(trailName: "Bassanova", trailLift: "Mineral Basin", trailDifficulty: "2", trailStatus: "", trailGroomed: "")
        let blueByYou = Trails(trailName: "Blue By You", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let chamonixBowl = Trails(trailName: "Chamonix Bowl", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let chamonixChutes = Trails(trailName: "Chamonix Chutes", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let doubleDown = Trails(trailName: "Double Down", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let fossilChutes = Trails(trailName: "Fossil Chutes", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let highStakes = Trails(trailName: "High Stakes", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let limberPines = Trails(trailName: "Limber Pines", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let livinTheDream = Trails(trailName: "Livin' the Dream", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let loneStar = Trails(trailName: "Lone Star", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let nashFloraLode = Trails(trailName: "Nash Flora Lode", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let notQuiteCorn = Trails(trailName: "Not Quite Corn", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let pathToParadise = Trails(trailName: "Path to Paradise", trailLift: "Mineral Basin", trailDifficulty: "3", trailStatus: "", trailGroomed: "")
        let silverDipper = Trails(trailName: "Silver Dipper", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let alimonyChutes = Trails(trailName: "Alimony Chutes", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let altarBowl = Trails(trailName: "Altar Bowl", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let bookendsBowl = Trails(trailName: "Bookends Bowl", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let bookendsTraverse = Trails(trailName: "Bookends Traverse", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let richiesRun = Trails(trailName: "Richie's Run", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let theEndoras = Trails(trailName: "The Endoras", trailLift: "Mineral Basin", trailDifficulty: "5", trailStatus: "", trailGroomed: "")
        let bookmarkGully = Trails(trailName: "Bookmark Gully", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
        let juniorsPowderParadise = Trails(trailName: "Junior's Powder Paradise", trailLift: "Mineral Basin", trailDifficulty: "3", trailStatus: "", trailGroomed: "")
        let whiteDiamonds = Trails(trailName: "White Diamonds", trailLift: "Mineral Basin", trailDifficulty: "4", trailStatus: "", trailGroomed: "")
